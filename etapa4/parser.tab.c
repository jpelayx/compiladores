...
{
       0,   158,   158,   160,   161,   163,   165,   165,   165,   165,
     165,   166,   166,   167,   167,   168,   169,   171,   187,   191,
     193,   207,   213,   221,   223,   231,   234,   240,   242,   246,
     247,   248,   249,   250,   251,   252,   253,   254,   255,   256,
     260,   264,   266,   268,   272,   281,   282,   283,   284,   285,
     286,   289,   290,   296,   297,   299,   315,   323,   330,   332,
     333,   335,   336,   346,   359,   360,   362,   370,   371,   372,
     374,   384,   385,   387,   398,   408,   409,   412,   413,   414,
     422,   423,   426,   430,   434,   438,   442,   446,   451,   456,
     461,   466,   471,   477,   483,   489,   490,   493,   501,   502,
     503,   506,   510,   515,   520,   525,   530,   535,   540,   546,
     551,   558,   567,   568,   569,   570,   572
};
#endif
...
yyreduce:
  ...
  case 2:
#line 158 "parser.y"
                {arvore = (yyvsp[0].nodo); sai_escopo(escopo); }
...
#line 172 "parser.y"
	 ...
	 libera((yyvsp[-1].nodo)); // libera arvore temporaria 
	}
...
#line 194 "parser.y"
		...
		insere_filho((yyvsp[-1].nodo), (yyvsp[0].nodo));
		(yyval.nodo) = (yyvsp[-1].nodo);
		escopo = sai_escopo(escopo); // fechando o escopo local na hora da redução
		simbolo_t *s = novo_simbolo();
		adiciona_valor_lexico(s, (yyvsp[-1].nodo)->valor_lexico);
		s->natureza = simbolo_funcao;
		s->tipo = (yyvsp[-1].nodo)->tipo_sem;
...
#line 2047 "parser.tab.c"
  ...
  case 67:
#line 370 "parser.y"
                         {(yyval.nodo) = (yyvsp[0].nodo); 		abre_escopo = true;}
